...
#SBATCH --output=/mnt/efs_v2/dbgap_tcga/users/tianrui.qi/SIP-DB2/data/out/selector_%A_%a.out
#SBATCH --error=/mnt/efs_v2/dbgap_tcga/users/tianrui.qi/SIP-DB2/data/out/selector_%A_%a.err
